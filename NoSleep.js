...
var IOS = function IOS() {
  return typeof navigator !== "undefined" && /CPU.*OS ([0-9_]{3,4})[0-9_]{0,1}|(CPU like).*AppleWebKit.*Mobile/i.exec(navigator.userAgent);
};
...
var NoSleep = function () {
  function NoSleep() {
    ...
    if (nativeWakeLock()) {
      ...
      this.noSleepVideo.setAttribute("title", "SIGO-Terrain");
